<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    ...
    <!-- Error Toast -->
    <div v-if="error" class="fixed top-4 right-4 bg-red-500 text-white px-6 py-3 rounded-lg shadow-lg z-40 flex items-center space-x-2">
    ...
    <div class="flex flex-col h-screen">
      ...
      <div class="flex-1 flex overflow-hidden">
        ...
        <main class="flex-1 overflow-y-auto p-6">
          ...
          <div v-if="!currentVault" class="flex flex-col items-center justify-center h-full text-center">
            <div class="bg-white dark:bg-gray-800 rounded-lg p-8 max-w-md">
              ...
              <h2 class="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Welcome to Scheduler-Monkey</h2>
              <p class="text-gray-600 dark:text-gray-400 mb-6">Select a vault directory to get started with script scheduling.</p>
              <button
...
function editSchedule(scriptFile: ScriptFile) {
  const existingSchedule = schedules.value.find(s => s.filePath === scriptFile.fullPath)
