    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center py-4">
        ...
        <div class="flex items-center space-x-3">
          ...
          <div>
            <h1 class="text-xl font-bold text-gray-900 dark:text-white">Scheduler-Monkey</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400">TypeScript Script Scheduler</p>
          </div>
        </div>
        ...
        <div class="flex items-center space-x-4">
          ...
          <div v-if="currentVault" class="flex items-center space-x-2 text-sm">
            ...
            <span class="text-gray-600 dark:text-gray-300">{{ currentVault.name }}</span>
            <button
